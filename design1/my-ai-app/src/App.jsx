...
import { ArrowRight, Server, Box, Activity, Terminal, Shield, Cpu, Globe, Anchor } from 'lucide-react';
...
const ArchitecturalScene = () => {
  ...
  useEffect(() => {
    ...
    const material = new THREE.LineBasicMaterial({ color: 0xeeeeee, linewidth: 1 }); // Make lines much lighter to not compete with product
    ...
    for (let x = -gridSize; x <= gridSize; x++) {
      ...
      for (let y = -gridSize; y <= gridSize; y++) {
        ...
        for (let z = -gridSize; z <= gridSize; z++) {
          ...
          if (Math.random() > 0.85) { // Sparser grid
...
const BentoCard = ({ title, subtitle, icon: Icon, span = "", children, dark = false, image }) => (
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <img
          ...
          className={`w-full h-full object-cover transition-all duration-700 ease-out grayscale group-hover:grayscale-0 group-hover:scale-110 
                    ...
                    ${dark ? 'opacity-30 group-hover:opacity-50' : 'opacity-10 group-hover:opacity-30'}`} // Subtle opacity
    ...
    <section className="w-full bg-[#f4f4f4] relative z-20" id="solutions">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 border-l border-t border-gray-200">
        ...
        <BentoCard
          ...
          image="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1000&auto=format&fit=crop" // Network abstract
        ...
        <BentoCard
          ...
          image="https://images.unsplash.com/photo-1558494949-ef2bb2298ce0?q=80&w=1000&auto=format&fit=crop" // Server Cabling
        ...
        <BentoCard
          ...
          image="https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1000&auto=format&fit=crop" // Chip macro
        ...
        <BentoCard
          ...
          image="https://images.unsplash.com/photo-1563206767-5b1d972b9fb9?q=80&w=1000&auto=format&fit=crop" // Abstract metal
        ...
        <BentoCard
          ...
          image="https://images.unsplash.com/photo-1591488320449-011701bb6704?q=80&w=1000&auto=format&fit=crop" // CPU
