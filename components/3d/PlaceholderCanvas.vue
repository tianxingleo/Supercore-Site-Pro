<template>
  <div class="w-full h-full relative flex items-center justify-end pr-[15%] bg-white overflow-hidden rounded-lg">
    <!-- Grid Background -->
    ...
    <div
      class="relative w-48 h-64 md:w-64 md:h-80 border border-gray-100 bg-gray-50/50 rounded-sm shadow-sm flex flex-col p-4 animate-pulse">
      <!-- Top Section -->
    ...
    <!-- Loading Text -->
    <div class="absolute bottom-8 right-8 flex flex-col items-center">
