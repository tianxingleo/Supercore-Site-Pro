<template>
  <div class="relative" ref="dropdownRef">
    <button
      class="flex items-center space-x-1 px-3 py-2 rounded hover:bg-swiss-secondary/10 transition-colors"
    ...
    >
      ...
      <svg
        class="w-4 h-4 text-swiss-text transition-transform"
    ...
    <Transition name="fade">
      ...
      >
        <button
          ...
          :class="{ 'bg-swiss-bg/50': locale.code === currentLocaleCode }"
        ...
        >
          ...
          <svg
            ...
            class="w-4 h-4 text-swiss-accent"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
